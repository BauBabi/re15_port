...
**Stand: 2026-08-02** — generiert von `analysis/coverage/generate_address_coverage.py`
...
2. **Overlay-Coverage je Stage:** analog über die Stage-Funktionslisten, nur für zitierte
   ...
   (2511 von 2529 Overlay-Zitaten treffen mehr als eine Stage).
...
3. **DAT_-Zitate (Daten-Globals):** Adressen, die mindestens einmal als `DAT_…` zitiert werden,
   ...
   dieselbe Adresse zusätzlich als rohes `0x…`-Literal zitiert wird (59 solcher Mischfälle).
...
| Metrik | Wert |
|---|---|
| Zitierte Original-Adressen im Port (unique) | **5053** |
| … davon DAT_-Daten-Globals (separat, nicht gemappt) | 186 (EXE-Raum 178, Overlay-Raum 8) |
| … davon Funktions-Zitate im EXE-Raum (< 0x80100000) | 2338 |
| … davon Funktions-Zitate im Overlay-Raum (>= 0x80100000) | 2529 |
| EXE-Funktionen (Decompile-Inventar) | 386 |
| EXE-Funktionen ZITIERT | **250** (64.8%) |
| EXE-Funktionen NICHT zitiert | 136 |
| EXE-Raum-Zitate auf Funktionen gemappt / ungemappt | 1875 / 463 (ungemappt = Datenraum oder > Start+0x4000) |
| Overlay-Zitate, die mehrere Stages treffen (Mehrdeutigkeit) | 2511 |
| Overlay-Zitate ohne Stage-Funktions-Treffer | 18 |
...
|---|---:|---:|---:|---:|---:|
| STAGE1 | 650 | 420 | 230 | 64.6% | 2491 |
| STAGE2 | 456 | 318 | 138 | 69.7% | 2312 |
| STAGE3 | 526 | 353 | 173 | 67.1% | 2478 |
| STAGE4 | 459 | 338 | 121 | 73.6% | 2399 |
| STAGE5 | 535 | 350 | 185 | 65.4% | 2511 |
| STAGE6 | 73 | 45 | 28 | 61.6% | 353 |
...
|---|---:|---:|---:|
| (ohne Katalog-Kontext) | 280 | 147 | 133 |
...
136 von 386 EXE-Funktionen ohne Adress-Zitat im Port-Code
...
800166c4  800170e0  800171b4  80019ca8  8001a504  8001e56c  8001e5b0  8001ef54
8001f1e0  8001f220  80020610  80020674  80020794  80020894  800209b8  800209ec
8002134c  80021bbc  80021eb4  80022150  80022300  8002288c  8002441c  80025360
800253fc  80025940  80025a98  80026c34  80026ca8  80026dd4  80026e54  80026f48
80026f90  80027108  80027160  800271a8  80027368  80027488  800275f0  800276b0
80027724  80027780  80027828  800278bc  8002877c  8002939c  80029560  80029690
800297c8  800298b0  800299a4  80029a28  80029b48  80029e84  80029f40  8002a050
8002a16c  8002a1b8  8002a8d0  8002abec  8002ac38  8002ad34  8002ad64  8002adb0
8002adf4  8002ae38  8002b7e8  8002bc04  8002d100  8002d2c0  8002d3d8  8002d7d8
8002dacc  8002f3f0  8002f600  8002f884  80037250  800396a8  80039a30  80039c2c
8003b558  8003bc2c  8003da78  8003e9d4  8003ea3c  8003ebf4  8003ec28  8003edbc
80043850  80043a34  80043b80  800440c4  80044fec  80045a18  8004694c  80046f68
