...
**Stand: 2026-08-04** — generiert von `analysis/coverage/generate_address_coverage.py`
...
2. **Overlay-Coverage je Stage:** analog über die Stage-Funktionslisten, nur für zitierte
   ...
   (2675 von 2698 Overlay-Zitaten treffen mehr als eine Stage).
...
3. **DAT_-Zitate (Daten-Globals):** Adressen, die mindestens einmal als `DAT_…` zitiert werden,
   ...
   dieselbe Adresse zusätzlich als rohes `0x…`-Literal zitiert wird (60 solcher Mischfälle).
...
| Metrik | Wert |
|---|---|
| Zitierte Original-Adressen im Port (unique) | **5431** |
| … davon DAT_-Daten-Globals (separat, nicht gemappt) | 190 (EXE-Raum 182, Overlay-Raum 8) |
| … davon Funktions-Zitate im EXE-Raum (< 0x80100000) | 2543 |
| … davon Funktions-Zitate im Overlay-Raum (>= 0x80100000) | 2698 |
| EXE-Funktionen (Decompile-Inventar) | 386 |
| EXE-Funktionen ZITIERT | **257** (66.6%) |
| EXE-Funktionen NICHT zitiert | 129 |
| EXE-Raum-Zitate auf Funktionen gemappt / ungemappt | 2068 / 475 (ungemappt = Datenraum oder > Start+0x4000) |
| Overlay-Zitate, die mehrere Stages treffen (Mehrdeutigkeit) | 2675 |
...
|---|---:|---:|---:|---:|---:|
| STAGE1 | 650 | 431 | 219 | 66.3% | 2655 |
| STAGE2 | 456 | 329 | 127 | 72.1% | 2456 |
| STAGE3 | 526 | 362 | 164 | 68.8% | 2638 |
| STAGE4 | 459 | 343 | 116 | 74.7% | 2543 |
| STAGE5 | 535 | 357 | 178 | 66.7% | 2675 |
| STAGE6 | 73 | 50 | 23 | 68.5% | 396 |
...
|---|---:|---:|---:|
| (ohne Katalog-Kontext) | 280 | 154 | 126 |
...
129 von 386 EXE-Funktionen ohne Adress-Zitat im Port-Code
...
800166c4  800170e0  800171b4  80019ca8  8001a504  8001e5b0  8001ef54  8001f1e0
8001f220  80020610  80020674  80020794  80020894  800209b8  800209ec  8002134c
80021bbc  80021eb4  80022150  8002288c  8002441c  80025360  800253fc  80025940
80025a98  80026c34  80026ca8  80026dd4  80026f90  80027108  80027160  800271a8
80027368  80027488  800275f0  800276b0  80027724  80027780  80027828  800278bc
8002877c  8002939c  80029560  80029690  800297c8  800298b0  800299a4  80029a28
80029b48  80029e84  80029f40  8002a050  8002a16c  8002a1b8  8002a8d0  8002abec
8002ac38  8002ad34  8002ad64  8002adb0  8002adf4  8002ae38  8002b7e8  8002bc04
8002d100  8002d2c0  8002d3d8  8002dacc  8002f3f0  8002f600  8002f884  80037250
800396a8  80039a30  80039c2c  8003b558  8003bc2c  8003da78  8003e9d4  8003ea3c
8003ebf4  8003ec28  8003edbc  80043850  80043a34  80043b80  80044fec  80045a18
8004694c  80046f68  800487b0  8004c830  8004d4c4  8004d96c  8004df90  8004edfc
8004ee60  8004f090  80052fd0  800537e4  80053a8c  8005a99c  8005abf8  8005ad40
8005f87c  8005f89c  8005fb00  80060d8c  800614d0  80064768  80066d60  8006e170
8006e468
```

## Anhang B — nicht-zitierte STAGE1-Overlay-Funktionen

219 von 650 STAGE1-Overlay-Funktionen ohne Adress-Zitat:

```
8010093c  801010f8  801012e8  801016f0  80101d48  801021e4  80102bbc  801031fc
801035e8  801036dc  80103978  801039fc  80103b94  80103d48  80103e6c  80103f60
80104008  801040e8  80104250  80104340  80104548  8010466c  80104760  80104780
80104b40  80105848  801060a0  80106238  8010626c  80106290  801063a4  80106418
80106624  801066dc  80106a24  80106ea0  80107200  80107244  801074b0  80107634
801076e0  80107c9c  801082bc  80108504  80108574  8010899c  801089e4  80108abc
80108af4  80108b9c  80108c70  80108d04  80108d54  80108d74  80109100  80109164
801091e4  801092dc  801092f4  80109470  801099cc  80109a08  80109a44  80109d74
80109d78  80109ef8  8010a0c8  8010a8b8  8010aed4  8010af84  8010b26c  8010b2e8
