...
- **➡️ NÄCHSTER SCHRITT = die letzten Work-Struct-Setter:** 0x3f/0x4a (state 4 + sub_state + motion@+0x94 + clear +0x1c8/+0x1ca) · 0x5d (+0x1c8/+0x1ca) — **+0x1c8/+0x1ca sind NICHT in der Member-Tabelle = unbekannte Entity-Felder** (vermutlich Anim-Timer/Velocity; brauchen Offset-benannte Actor-Felder ODER RE wer sie liest → ggf. defer/raten-verboten). Dann: 0x3d/0x3e (get-field→Register, FUN_80041358), 0x5a/0x5b (arith auf Ziel-Feld, FUN_80041554). Danach die anderen Gruppen: Effekt-Pool (ESP-B, 0x2d/0x48/0x4c/0x4d) · Draw/GTE (C3) · Game-Flags · Audio/RNG/Spawn.
