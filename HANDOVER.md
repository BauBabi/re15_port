...
- **➡️ NÄCHSTER SCHRITT = die restlichen Work-Struct-Setter** (gleiches Muster, Offset→Actor-Feld): 0x3f (anim/mode +0x154-struct), 0x4a (mode 4 + submode), 0x43 (+0x1c4 OR/XOR), 0x5d (+0x1c8/0x1ca), 0x34/0x35 (member via FUN_8004116c), 0x3d/0x3e (get-field, FUN_80041358), 0x5a/0x5b (arith auf Ziel-Feld). Manche Offsets (+0x1c4/+0x1c8) sind evtl. effekt-spezifisch (kind 3/5 Pool, nicht Actor) → ggf. defer. Danach: Effekt-Pool (ESP-B) · Draw/GTE (C3) · Game-Flags · Audio/RNG/Spawn.
