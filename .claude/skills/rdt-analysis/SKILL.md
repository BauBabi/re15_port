---
name: rdt-analysis
description: Analysiert eine RE1.5 RDT-Datei (Room Definition Table) und gibt pro Sektion (Header, Adresstabelle, Kollision, Kamera, SCD, Modelle, Texturen) Name, Offset, Größe und Einträge-Anzahl aus. Verwenden bei Fragen zur RDT-Struktur, zu Sektions-Offsets oder beim Inspizieren einer ROOM*.RDT-Datei.
---
