---
name: scd-disassembly
description: Übersetzt SCD-Bytecode aus einer RE1.5 RDT-Datei in zeilenweisen Pseudo-Code (Offset, Opcode-Name, Parameter, Beschreibung) anhand der verifizierten RE1.5-Opcode-Tabelle (0x00–0x8E). Verwenden zum Disassemblieren von mainScd/subScd, zum Finden von Türen/Events oder zum Dekodieren einzelner Opcodes.
---
