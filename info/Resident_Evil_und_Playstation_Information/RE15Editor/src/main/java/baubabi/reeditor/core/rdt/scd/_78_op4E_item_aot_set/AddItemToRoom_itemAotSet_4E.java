package baubabi.reeditor.core.rdt.scd._78_op4E_item_aot_set;
...
@Getter
@NoArgsConstructor
public class AddItemToRoom_itemAotSet_4E {
    //22 Byte
    ...
    */
    ...
    //1 byte
    private final String OPCODE = "4E"; /* 0x4e */
    ...
    private final String displayName = OPCODE + " - add item to room";

    public AddItemToRoom_itemAotSet_4E(String addItemToRoomValue) {
