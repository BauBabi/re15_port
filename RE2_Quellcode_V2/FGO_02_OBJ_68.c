/* FGO_02_OBJ_68 @ 0x8008e4ec  (Ghidra headless, raw MIPS overlay) */
...

{
  ...
  iVar4 = (int)(short)*(int *)(&DAT_800adeac + ((int)*(short *)(param_1 + 2) & 0xfffU) * 4);
  iVar2 = *(int *)(&DAT_800adeac + ((int)*(short *)(param_1 + 2) & 0xfffU) * 4) >> 0x10;
  ...
  if (-1 < sVar1) {
    param_2[8] = sVar6;
    iVar5 = (int)(short)*(int *)(&DAT_800adeac + ((int)sVar1 & 0xfffU) * 4);
    iVar3 = *(int *)(&DAT_800adeac + ((int)sVar1 & 0xfffU) * 4) >> 0x10;
