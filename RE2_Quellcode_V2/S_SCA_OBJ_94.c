/* S_SCA_OBJ_94 @ 0x8007cf98  (Ghidra headless, raw MIPS overlay) */

/* WARNING: Removing unreachable block (ram,0x8007cfa8) */
/* WARNING: Removing unreachable block (ram,0x8007cfbc) */
/* WARNING: Removing unreachable block (ram,0x8007cfc4) */
/* WARNING: Removing unreachable block (ram,0x8007cfcc) */
/* WARNING: Removing unreachable block (ram,0x8007cfd0) */
...

{
  ...
  *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_800ab21c + 0x180) = *(ushort *)(param_1 + 4) & 0x7fff;
  if (in_t2 == 0) {
