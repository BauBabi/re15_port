/* S_M_INT_OBJ_50 @ 0x80085010  (Ghidra headless, raw MIPS overlay) */
...
code_r0x80085010:
  ...
  while( true ) {
    param_4 = param_4 + 2;
    in_t1 = iVar7 + 1;
    if (DAT_800ab6f0 < in_t1) break;
    param_3 = iVar7 + 2;
    iVar7 = in_t1;
    if ((*param_4 & in_t4) != 0) goto code_r0x80085008;
  }
  iVar7 = 0;
  puVar4 = DAT_800ab6f4;
  if (-1 < DAT_800ab6f0) {
  ...
  if (-1 < DAT_800ab6f0) {
    do {
      ...
      if (*puVar3 == 0x2fffffff) {
        puVar4 = DAT_800ab6f4 + DAT_800ab6f0 * 2;
        *puVar3 = *puVar4;
        DAT_800ab6f0 = iVar8;
        puVar3[1] = puVar4[1];
        S_M_INT_OBJ_278();
