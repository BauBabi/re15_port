/* _SsSetNrpnVabAttr8 @ 0x8007baa0  (Ghidra headless, raw MIPS overlay) */

void _SsSetNrpnVabAttr8(short param_1,short param_2,short param_3,VagAtr param_4,short param_5,
                       uchar param_6)
