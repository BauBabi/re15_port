/* FGO_01_OBJ_64 @ 0x8008e258  (Ghidra headless, raw MIPS overlay) */
...

{
  ...
  sVar5 = (short)*(int *)(&DAT_800adeac + ((int)*(short *)(param_1 + 2) & 0xfffU) * 4);
  iVar7 = -(int)sVar5;
  ...
  if (-1 < sVar1) {
    param_2[8] = uVar6;
    iVar4 = (int)(short)*(int *)(&DAT_800adeac + ((int)sVar1 & 0xfffU) * 4);
