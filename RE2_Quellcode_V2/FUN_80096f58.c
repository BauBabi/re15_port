/* FUN_80096f58 @ 0x80096f58  (Ghidra headless, raw MIPS overlay) */

undefined4 FUN_80096f58(int *param_1,int param_2)
  ...
  if (param_2 != 0) {
    ...
    if (iVar1 == 0) {
      ...
      *(undefined1 *)((int)param_1 + 0x46) = 1;
      param_1[5] = (int)&LAB_8009702c;
      param_1[6] = (int)&LAB_800970d4;
      iVar1 = (param_2 + 3 >> 2) * 4;
      *param_1 = iVar1;
