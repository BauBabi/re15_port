/* FUN_80060650 @ 0x80060650  (Ghidra headless, raw MIPS overlay) */

void FUN_80060650(int param_1,undefined4 param_2,undefined4 param_3)
    ...
    *(ushort *)(param_1 + 0x21c) = uVar4 & 0x7fff;
    if ((uVar1 & 0xf) != (*(ushort *)(param_1 + 0x10e) & 0xf)) {
      ...
      *(ushort *)(param_1 + 0x21c) =
           uVar4 | (byte)(&DAT_800a8668)[*(ushort *)(param_1 + 0x10e) & 0xf] | 0x8000;
    }
    cVar2 = '\x0f';
  }
  DAT_800a8673 = cVar2;
  (*(code *)(&PTR_LAB_800a863c)[*(ushort *)(param_1 + 0x10e) & 0xf])(param_1,param_2,param_3);
  return;
}
