/* FUN_8002cd24 @ 0x8002cd24  (Ghidra headless, raw MIPS overlay) */

undefined4 * FUN_8002cd24(uint *param_1,undefined4 *param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    if (((uint)puVar11 & 0xff000000) == 0xff000000) {
      FUN_80010778(param_2,(uint)puVar11 & 0xffffff | 0x80000000,iVar10 * 0x68);
      return puVar12;
    }
