/* FUN_8001cbe8 @ 0x8001cbe8  (Ghidra headless, raw MIPS overlay) */

uint FUN_8001cbe8(uint param_1,undefined2 param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  *(undefined2 *)((int)&DAT_800d8d08 + iVar4) = 0x4000;
  ...
  *(undefined4 *)(&UNK_800d8d04 + iVar4) = *(undefined4 *)(*(int *)(&UNK_800d8d68 + iVar4) + 0x14);
  if (iVar13 != 0) {
    ...
    do {
      ...
      *(undefined2 *)(&UNK_800d8c8c + iVar4) = 0x4000;
