/* FUN_8001c8c4 @ 0x8001c8c4  (Ghidra headless, raw MIPS overlay) */

uint FUN_8001c8c4(uint param_1,uint param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  *(uint *)(&DAT_800d8d0c + iVar4) = (param_1 >> 0x18) + (param_2 & 0xff) * 0x100 + uVar15 * 0x10000
  ;
  uVar3 = puVar11[5];
  *(short *)(&UNK_800d8d12 + iVar4) = (short)(param_2 >> 0x10);
