/* DecDCTvlc @ 0x80095004  (Ghidra headless, raw MIPS overlay) */
...

{
  ...
  if (bs == (u_long *)0x0) {
    puVar19 = DAT_80095348 + VLC_OBJ_0;
    uVar7 = DAT_8009534c;
    uVar8 = DAT_80095350;
    puVar9 = VLC_OBJ_374;
    puVar5 = DAT_80095348;
...
VLC_OBJ_204:
  puVar10 = puVar5;
  iVar13 = (uVar7 >> 0x13) * 8;
  uVar14 = *(uint *)(&DAT_800b316c + iVar13);
  if (uVar14 == 0) {
    uVar7 = uVar7 << 8;
    uVar15 = uVar8 + 8;
    uVar8 = uVar15 & 0xf;
    ...
    uVar14 = *(uint *)(&DAT_800c316c + (uVar7 >> 0x17) * 4);
    uVar12 = 0;
  }
  else {
    uVar12 = *(uint *)(&DAT_800b3170 + iVar13);
  }
  ...
  *puVar10 = (short)(uVar14 >> 0x10);
  uVar15 = uVar7;
  if (uVar14 >> 0x10 != 0xfe00) goto code_r0x80095270;
  goto VLC_OBJ_E8;
code_r0x80095270:
  puVar11 = puVar10 + 1;
  puVar5 = puVar11;
