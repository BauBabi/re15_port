/* CC_6_OBJ_1C0 @ 0x8007aa54  (Ghidra headless, raw MIPS overlay) */

void CC_6_OBJ_1C0(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  do {
    ...
    SsUtSetVagAtr((ushort)*(byte *)(unaff_s0 + 0x26),(ushort)*(byte *)(unaff_s6 + 0x37),
                  (short)param_3,(VagAtr *)&stack0x00000048);
