...
| FUN_80104178 | **Zombie attack-POINT computation** (writes ent+0x28/+0x2a/+0x2c, the world hitbox point FUN_80017fa4 reads). NOT a simple pos+facing: GTE matrices (func_0x800659d0 RotMatrix / func_0x80067a28 / func_0x80022da0) on the model/anim pool (ent+0x188 + idx*0xac), a forward-delta add (puVar3[0xe]/[0xf] + the point), and floor/collision iteration (func_0x8001c2dc). **DEFERRED** (entangled with the GTE + model-pool, not yet ported) | STAGE1_full/FUN_80104178.c | med |
