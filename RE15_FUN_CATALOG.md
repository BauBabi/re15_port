...
| zombie FSM tables (RAM-read HASH_1.sav) | **AI-state dispatch** (entity+0x4 low byte): LOGIC table PTR_FUN_801217a0 @0x801217a0 = 22 entries [0-5 overlay 0x8011xxxx, 4=0x80050be8, 6-21 shared EXE 0x8004f1xx-0x80051xxx]; ANIM table PTR_FUN_80120208 @0x80120208 (heterogeneous: idx0-7 grp, 8/9 = embedded `02 03 04 05` data, 10-23 grp w/ dup pairs; FUN_80101b64 = anim idx 23). FUN_8011d6d4 (type-0x47 entry @0x80072bac) dispatches BOTH each tick. Stationary room1140 zombie = state 4 (ent+0x4=0x00020004), action idx 1. ⚠️ which state is the LUNGE not yet identified statically (needs handler-chain trace or a mid-lunge savestate) | HASH_1.sav RAM @0x153202/0x151c6a | high |
