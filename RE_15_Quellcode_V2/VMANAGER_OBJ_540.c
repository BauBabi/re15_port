void VMANAGER_OBJ_540(undefined4 param_1,int param_2,int param_3)

{
  ...
  (&DAT_8008f6ac)[uVar2] = (short)((uint)(param_3 * param_3) / 0x3fff);
  (&DAT_8008f6ae)[uVar2] = (short)((uint)(param_2 * param_2) / 0x3fff);
