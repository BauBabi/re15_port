void VMANAGER_OBJ_434(undefined4 param_1,uint param_2,int param_3)

{
  ...
  if (uVar2 < 0x40) {
    VMANAGER_OBJ_4A4(param_1,(param_2 * uVar2) / 0x3f);
    return;
  }
  uVar3 = (uint)DAT_800b5319;
  if (uVar3 < 0x40) {
    VMANAGER_OBJ_514(param_1,(param_2 * uVar3) / 0x3f);
    return;
  }
  uVar3 = (((param_3 * (0x7f - uVar2)) / 0x3f) * (0x7f - uVar3)) / 0x3f;
  uVar2 = param_2;
  if ((DAT_800b2678 == 1) && (uVar2 = uVar3, uVar3 < param_2)) {
    VMANAGER_OBJ_540(param_1,param_2,param_2);
    return;
  }
  uVar4 = in_t1 & 0xffff;
  (&DAT_8008f6b0)[uVar4] = in_t0;
  (&DAT_8008f6ac)[uVar4] = (short)((uVar3 * uVar3) / 0x3fff);
  (&DAT_8008f6ae)[uVar4] = (short)((uVar2 * uVar2) / 0x3fff);
