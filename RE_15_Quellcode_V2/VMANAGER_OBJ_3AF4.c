int VMANAGER_OBJ_3AF4(uint param_1,uint param_2,uint param_3)

{
  ...
  while( true ) {
    ...
    if (uVar1 < 0x40) {
      ...
      iVar5 = VMANAGER_OBJ_3B90(iVar5 + (param_1 * uVar1 - iVar5 >> 1) >> 5);
      return iVar5;
    }
    ...
    uVar1 = (iVar5 + (param_3 - iVar5 >> 1) >> 5) * (in_t5 - uVar1);
    iVar5 = (int)((ulonglong)uVar1 * (ulonglong)in_t1 >> 0x20);
    uVar3 = iVar5 + (uVar1 - iVar5 >> 1) >> 5;
    uVar1 = param_1;
