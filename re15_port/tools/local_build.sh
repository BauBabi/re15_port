...
#   RE15_MIN_TESTS  Standard: 239 (untere Schranke gegen eine KOLLABIERTE Suite,
...
do_test() {
    ...
    [ "$total" -ge "${RE15_MIN_TESTS:-239}" ] \
      || die "nur $total Tests gefunden, erwartet >= ${RE15_MIN_TESTS:-239} — Suite kollabiert? (RE15_MIN_TESTS setzen, wenn das ABSICHT ist)"
