...
int main(void)
{
    ...
    /* SCHRANKE GEGEN RUECKSCHRITT. Gemessen am Stand 2026-09-06: 7232 Standplaetze
    ...
    CHECK("Schnitte durch nachgezeichnete Masken nicht mehr als am Stand 2026-09-06",
          ges_geschnitten <= 7232);
    return g_fail;
}
