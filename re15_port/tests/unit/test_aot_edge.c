...
int main(void)
{
    ...
    while (re15_item_modal_active()) re15_item_modal_tick(0x4000, 0);   /* virtual confirm dismisses the can't-carry box */
    ...
    g_aot_action_pressed = 0;
    while (re15_item_modal_active()) re15_item_modal_tick(0x4000, 0);   /* confirm(Yes) -> grant + self-disable */
