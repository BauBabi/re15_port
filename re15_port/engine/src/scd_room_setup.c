                      ...
                      uint8_t entry_scenario)
{
    ...
    /* ⛔ KEIN Reset: die Vormerkung ueberlebt den Raumwechsel; nur Faden und Platz fallen
     * weg. RE2 kennt die Lage nicht (dort ist "vorgemerkt" == "Nachricht haelt 0xFF000000",
     * @0x800517f4 gegen LAB_800307e0), messbar ist nur die Datenlage: zwei Zellen im
     * raum-uebergreifenden Block (DAT_800d4498 +0x82b0 / DAT_800d4249 +0x8061 ueber
     * 0x800cc1e8), 6 Schreibstellen, keine auf dem Raum-Pfad, residente Fortsetzung
     * LAB_80051718. Das Ueberleben ist danach eine PORT-Entscheidung — voller Beleg samt
     * Abgrenzung an der Definition von re15_discard_room_change. */
    { extern void re15_discard_room_change(void); re15_discard_room_change(); }
